...
public class StatusOverloadToolMod extends AbstractMod {
    ...
    public List<MutableComponent> getUniqueInfo(int modLevel) {
        return List.of(
                Component.translatable("functions.yagens_attributes.status_overload_tool_mod.1", String.format("%.2f", ServerConfigs.MOD_LEGENDARY_CONDITION_OVERLOAD.get().floatValue() * modLevel))
        );
    }
